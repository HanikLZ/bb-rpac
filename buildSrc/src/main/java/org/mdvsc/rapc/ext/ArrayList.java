...
public class ArrayList<E> extends AbstractList<E> implements List<E>, RandomAccess {
    ...
    public ArrayList(Collection<? extends E> c) {
        Object[] a = c.toArray();
        if ((size = a.length) != 0) {
            elementData = (c instanceof ArrayList<? extends E>) ? a : Arrays.copyOf(a, size);
        } else {
    ...
    public <T> T[] toArray(T[] a) {
        if (a.length < size) return (T[]) Arrays.copyOf(elementData, size);
    ...
    public boolean equals(Object o) {
        ...
        boolean equal = (o instanceof ArrayList)
    ...
    boolean equalsRange(List<?> other, int from, int to) {
        ...
        for (; from < to; from++) {
            if (!oit.hasNext() || !equals(es[from], oit.next())) {
                return false;
            }
        }
        return !oit.hasNext();
    ...
    public ListIterator<E> listIterator(int index) {
        rangeCheckForAdd(index);
        return new ArrayListItr<>(index, this, modCount);
    }
    ...
    public ListIterator<E> listIterator() {
        return new ArrayListItr<>(0, this, modCount);
    }
    ...
    @SuppressWarnings("unchecked")
    void sortRange(Comparator<? super E> c, int fromIndex, int toIndex) {
        final int expectedModCount = modCount;
